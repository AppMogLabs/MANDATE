...
contract OrderBookTest is Test {
    ...
    function setUp() public {
        ...
        // Mint tokens (RATE has zero initial supply — use mint)
        rateToken.mint(seller, INITIAL_RATE_BALANCE / 2);
        rateToken.mint(buyer, INITIAL_RATE_BALANCE / 2);
    ...
    function test_MatchOrder_FullFill() public {
        ...
        // Reputation no longer auto-updated by OrderBook
        // assertGt(reputationLedger.getReputation(buyer), 0);
        // assertGt(reputationLedger.getReputation(seller), 0);
    }
